...
ALLOWED_HOSTS =  ['.elasticbeanstalk.com', '172.31.42.170']
...
DATABASES = {
    'default': dj_database_url.config(default=f'postgres://{os.getenv("DB_USER")}:{os.getenv("DB_PASSWORD")}@{os.getenv("DB_HOST")}:5432/{os.getenv("DB_NAME")}')
}
# Password validation
